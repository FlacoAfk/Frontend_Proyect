...
export class IdentityService {
  ...
  update(id: any, request: any): Observable<any> {
    return this.httpClient.put<any>(this.baseURL + '/update/' + id, request);
  }

  changePassword(id: any, request: any): Observable<any> {
    return this.httpClient.put<any>(this.baseURL + '/change-password/' + id, request);
  }
